      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-16 text-center">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg max-w-2xl mx-auto">
            <h3 className="text-xl font-serif text-charcoal mb-4">Need Help Choosing?</h3>
            <p className="text-charcoal/70 mb-6">
              Our wellness experts are here to help you select the perfect treatment for your needs.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="hover:text-sage transition-colors duration-200 cursor-pointer">Signature Glow Facial</li>
                <li className="hover:text-sage transition-colors duration-200 cursor-pointer">Complete Renewal Package</li>
                <li className="hover:text-sage transition-colors duration-200 cursor-pointer">Wellness Membership</li>
                <li className="hover:text-sage transition-colors duration-200 cursor-pointer">Consultation Services</li>
              </ul>
            </div>
